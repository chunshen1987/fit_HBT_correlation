...
#ifndef SRC_FIT_CORRELATION_H_
#define SRC_FIT_CORRELATION_H_
...
int Fittarget_correlfun3D_f_withlambda(
        const gsl_vector *xvec_ptr, void *params_ptr, gsl_vector *f_ptr);
int Fittarget_correlfun3D_df_withlambda(
...
class fit_correlation {
 ...
 public:
    ...
    void find_minimum_chisq_correlationfunction_o_s_and_l_lambda_fixed(
                                                                double q_fit);
    ...
    int print_fit_state_3D_withlambda_gsl(
                    size_t iteration, gsl_multifit_fdfsolver * solver_ptr);
